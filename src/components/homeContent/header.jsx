    ...
    return(
        <header className='flex justify-between item-center text-white'>
           ...
           {removeCart ? "" : <label htmlFor="searchbar" className="flex relative justify-center items-center">
                <input type="text" value={searchText} placeholder="Search for food, coffee,etc..." className='w-56 h-12 rounded-lg text-lighter-text bg-input-bg border-2 border-line pl-8 text-sm outline-none' onChange={searchItems}/>
