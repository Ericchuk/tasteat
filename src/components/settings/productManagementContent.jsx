...
export default function ProductMangementContent(){
  const {pushToOrderBoard, discardItems} = useContext(AppContext)
    return(
        ...
        <CartFooterButton button1="Discards Changes" onClick1={discardItems} button2="Save changes" onClick2={pushToOrderBoard} />
      </footer>
          </aside>
