      ...
      <aside key={item.id} className="flex justify-between items-center my-4">
        <div>
          <aside className="flex justify-between items-center w-11/12 mb-2">
            <img src={item.itemImage} alt={item.itemName} className="w-12 rounded-circle mr-2"/>
            <span className="w-8/12 block">
              <p className="w-11/12 truncate font-medium">{item.itemName}</p>
        ...
        <aside className="flex justify-between items-center flex-col">
          ...
          <span className="flex justify-center items-center w-12 h-12 border border-bg-icons rounded-lg">
            <img src={bin} alt="bin" />
            {open}
          </span>
        </aside>
