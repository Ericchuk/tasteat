    ...
    return(
        <section className="py-4">
            ...
            <aside className="flex justify-start items-start flex-col">
                <input type="text" placeholder="1234 Cherry Blossom Lane Springfield, USA 12345" className="w-full rounded-lg p-3.5 h-16 bg-bg-color my-3" />
                <label className="my-3">Delivery Note</label>
                <input type="text" placeholder="Knock the door 3 times" className="bg-bg-color h-12 rounded-lg w-full p-3.5" />
            </aside>
        </section>
    )
}